...
C_RATE_CONFIGS: Dict[str, List[int]] = {
    ...
    "C5_1p5_2p0C": [3, 4],
    "C6_0p5_2p5C": [1, 5],
    "C7_0p5_1p0_1p5C": [1, 2, 3],
    "C8_0p5_1p5_2p5C": [1, 3, 5],
    "C9_1p5_2p0_2p5C": [3, 4, 5],
    "C10_All": [1, 2, 3, 4, 5],
}
...
def _add_c_rate_summary_columns(summary: pd.DataFrame) -> pd.DataFrame:
    """
    Add relative change columns using C10_All as the reference.
    """
    if summary.empty:
        return summary

    if "C10_All" not in set(summary["config"]):
        return summary

    ref = summary.loc[summary["config"] == "C10_All"].iloc[0]
