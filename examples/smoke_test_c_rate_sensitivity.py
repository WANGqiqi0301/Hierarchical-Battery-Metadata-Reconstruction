# examples/smoke_test_c_rate_sensitivity.py
# -*- coding: utf-8 -*-
...
def main() -> None:
    ...
    output_root = PROJECT_ROOT / "results" / "smoke_test_c_rate_sensitivity"
    ...
    assert "num_c_rates" in summary.columns
    assert "n_train" in summary.columns
    assert "n_test" in summary.columns

    print("[PASS] C-rate sensitivity smoke test passed.")
